...
const UpdateCartaForm = () => {
	...
	const onSubmit = (data: z.infer<typeof FormSchema>) => {
		const color = obtenerColoresPorTipo(estilo) ?? {
			id: "default",
			tipo: "default",
			left_side: "",
			right_side: "",
		...
		putCarta(nuevaCarta);
		toast.success("La carta ha sido actualizada");
	...
	return (
		<Form {...form}>
			<form onSubmit={form.handleSubmit(onSubmit)}>
				<div className='grid grid-cols-1 md:grid-cols-2 p-2 gap-x-10 gap-y-2 overflow-y-scroll'>
					<FormField
						name='estilo'
						render={({ field }) => (
							<FormItem>
...
export default UpdateCartaForm
