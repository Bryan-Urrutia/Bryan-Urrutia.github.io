									...
									<ScrollArea className='flex max-h-full relative flex-col overflow-hidden w-full'>
										...
										<Popover >
											...
											<PopoverContent className='z-50 data-[state=open]:!zoom-in-0 data-[state=closed]:!zoom-out-0 origin-top duration-400 h-[500px] w-96 -left-5 border-4 bg-pink-50 border-pink-200 rounded-lg lg:flex flex-col items-center p-6 relative my-10'>
												...
												>
													<Image
														src={`/image/carta${carta?.color?.tipo.replace(/\s+/g, '')}.webp`}
														alt="test"
														fill
														className="object-cover border-4 border-yellow-500 shadow-[0_0_15px_3px_rgba(255,215,0,0.8)]"
													/>
										...
										<div className="grid grid-cols-1 py-7 p-4 lg:p-0 lg:pt-10 lg:grid-cols-4 items-center w-full relative z-40">

											<Flores />

											<div className="flex flex-col lg:flex-row col-span-2 mx-auto mt-10 lg:mt-20 relative">

												{/* Carta izquierda */}
												<div className="bg-[#eee] p-3 rounded-tr-2xl rounded-bl-2xl min-w-[360px] lg:w-[360px] lg:h-[500px] lg:[transform:skew(10deg,20deg)]">
													<h2 className="select-none text-4xl text-pink-300 text-center font-sacramento font-bold">
														{carta.de}
													</h2>
													<p className="pt-1 select-none text-3xl text-justify text-primary dark:text-black px-2 font-sacramento">
														{carta.izquierda}
													</p>
												</div>

												{/* Carta derecha */}
												<div className="bg-[#eee] p-3 mt-2 rounded-tl-2xl rounded-br-2xl min-w-[360px] lg:w-[420px] lg:h-[500px] lg:[transform:skew(10deg,-15deg)]">
													<p className="py-3 select-none text-3xl text-justify dark:text-black text-primary px-2 font-sacramento">
														{carta.derecha}
													</p>
													<p className="flex justify-end select-none text-4xl text-pink-300 font-sacramento font-bold">
														{carta.para}
													</p>
												</div>
