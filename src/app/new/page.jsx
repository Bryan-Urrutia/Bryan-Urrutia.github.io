    ...
    <section className="bg-light dark:bg-dark min-h-screen bg-no-repeat bg-center bg-cover bg-fixed md:pb-16 w-full">
      ...
      <Tabs defaultValue="about">
        <div className="container grid md:flex md:gap-10 justify-between lg:mt-[50px]">
          ...
          {/* <div className="col-span-2 h-fit justify-center items-center flex flex-col gap-y-4 sticky top-44">
            <div className="w-[100px] h-fit hidden lg:block p-[10px] rounded-lg bg-background">
              <TabsList className="flex flex-col gap-y-4">
                ...
                >
                  {item.icon}
                  <span className="font-serif text-base transition-all duration-200 px-4">
                    {item.title}
                  </span>
                </TabsTrigger>
                })}
