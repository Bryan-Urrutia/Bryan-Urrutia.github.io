  ...
  return (
    <>
      <section className="flex flex-row gap-x-4 min-h-screen bg-repeat bg-center bg-cover bg-fixed w-full p-2 mr-10">
        ...
        <article className="container mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10 my-5 h-screen items-center place-items-center pt-10 md:pt-0">
          {recuerdos
